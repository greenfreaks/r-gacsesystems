        ...
        <section id="userReg" class="userReg boxShadow">
            <form id="userReg__form" class="userReg__form">
                ...
                <div class="userReg__formData">
                    ...
                    <input type="text" class="medico_name" required>

                    <p class="darkOrangeTx">Email</p>
                    <input type="email" class="medico_email" required>

                    <p class="darkOrangeTx">Contraseña</p>
                    <input type="password" class="medico_pdw1" required>

                    <p class="darkOrangeTx">Confirme su contraseña</p>
                    <input type="password" class="medico_pdw2" required>

                    <button type="button" class="btnRegLog smBtn bgDarkBlue whiteTx">Registrarse</button>
